...
| 5 | `clean_matte` boundary conditions (`test_color_utils.py`) — all-zero input, all-opaque input, idempotency on connected-components core (`dilation=0, blur_size=0`). | `README.md`: *"Auto-Cleanup: morphological cleanup system."* | PR submitted upstream as nikopueringer/CorridorKey#177 |
